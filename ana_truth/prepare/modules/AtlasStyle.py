...
def ATLASLabel(x,y,shift, w1=0, w2=0): 
  l=TLatex() 
  l.SetNDC()
  l.SetTextFont(72)
  ...
  p.DrawLatex(x+shift,y,"Internal");

def ATLASLabelSimulation(x,y,shift, w1=0, w2=0):
  l=TLatex()
  l.SetNDC()
  l.SetTextFont(72)
  # l.SetTextColor(color)
  ...
  p.SetTextFont(42)
  # p.SetTextColor(color)
  p.DrawLatex(x+shift,y,"Simulation");


def ATLASLabel6(x,y,shift, w1=0, w2=0):
  l=TLatex()
  l.SetNDC()
  l.SetTextFont(72)
  # l.SetTextColor(color)
...
def ATLASLabel2(x,y,shift,Preliminary=False,color=1):
  l=TLatex()
  l.SetNDC()
  l.SetTextFont(72)
  l.SetTextColor(color)
  ...
  if (Preliminary):
    ...
    p.DrawLatex(x+shift,y,"Preliminary");
    # p.DrawLatex(x+shift,y,"Work in Progress");

def ATLASLabel3(x,y,Preliminary=True):
  shift=0.14
  l=TLatex()
  l.SetNDC()
  l.SetTextFont(72)
...
def ATLASLabel4(x,y,fsize,shift,Preliminary=True):
  l=TLatex()
  l.SetNDC()
  l.SetTextFont(72)
  l.SetTextColor(1)
